...
| E-03 | Admin UI baseline | E | DONE | codex | runtime-v1.0.8 | multi-page operator UI with overview, conversations, tasks, people, chats, operator actions, and live-verified detail drill-downs |
